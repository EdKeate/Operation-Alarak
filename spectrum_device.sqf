...
//settings for Car frequencies and amplitudes
EDS_minCarFreq = 146;
EDS_avgCarFreq = 200;
EDS_maxCarFreq = 324;
EDS_minCarDb = 0.8;
...
//settings for consumer frequencies and amplitudes
EDS_minRadiofreq = 70;
EDS_avgRadiofreq = 110;
EDS_maxRadiofreq = 128;
EDS_minRadioDb = 60;
EDS_avgRadioDb = 70;
EDS_maxRadioDb = 80;


//settings for military grade radio frequencies and amplitudes
EDS_minMilspecfreq = 546;
EDS_avgMilspecfreq = 560;
EDS_maxMilspecfreq = 580;
EDS_minMilspecDb = 38;
EDS_avgMilspecDb = 40;
EDS_maxMilspecDb = 43;
...
[clear_building_destination,666,100],

[spectrum_intro_freq_1,555,100],
[spectrum_intro_freq_2,565,100],

[demo_spectrum_beacon,615,15],

[spectrum_intro_heli_1,460,100]
...
sa_beaconsObjects = [];
sa_beaconsFreqs = [];
for "_i" from 0 to (count sa_beacons) -1 do {
	sa_beaconsObjects Pushback ((sa_beacons select _i) select 0);
	sa_beaconsFreqs Pushback ((sa_beacons select _i) select 1);
};
...
//Script settings
sa_tan_limit=0.2;//Antenna tangens (distance from center of screen)
