...
sa_str_message_scan=if (isLocalized "STR_SA_Scan") then { localize "STR_SA_Scan" } else {"<t color='#ff0000'> %2 </t><br />Unidentified signals: %3<br />Weak signals: %4</t>"};
...
sa_scan_friendly_foe={
	...
	["fnc\EDS_unlockCar.sqf"] remoteExec ["execVM", player];	
};
